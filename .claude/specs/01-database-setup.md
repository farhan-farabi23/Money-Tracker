...
This step establishes the **data layer foundation** for the Money Tracker application.
...
- Opens connection to `money_tracker.db` (or `expense_tracker.db`) in project root
- Sets:
